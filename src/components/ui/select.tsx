...
// Inline CaretSortIcon component to replace @radix-ui/react-icons
...
// Inline CheckIcon component to replace @radix-ui/react-icons
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-xl border border-input bg-transparent px-4 py-3 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-terracotta-DEFAULT focus:ring-offset-2 focus:border-terracotta-DEFAULT disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 hover:shadow-md",
      className,
    )}
    {...props}
  >
